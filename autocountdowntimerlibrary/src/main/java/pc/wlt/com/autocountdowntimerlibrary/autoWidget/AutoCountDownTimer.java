package pc.wlt.com.autocountdowntimerlibrary.autoWidget;
...
public abstract class AutoCountDownTimer extends CountDownTimer{
     ...
     */
    private String format_hh_mm_ss = "HH:mm:ss";//默认倒计时格式

    private TextView mTextView;//显示位置
